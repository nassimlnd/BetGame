...
{
    public static function setBaseCoteMatch(mysqli $conn, int $matchid, string $sport, string $league)
    {
    ...
    public static function checkCoteMatch(int $matchid, mysqli $conn, string $sport, string $league): bool
    {
    ...
    public static function getCoteMatch(mysqli $conn, int $matchid, string $bet, string $sport, string $league): int
    {
