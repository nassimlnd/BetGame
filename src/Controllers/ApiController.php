...
class ApiController
{
    public static function refreshBasket(string $pagename): void
    {
        $league = array(
            0 => 12,
            1 => 20,
    ...
    public static function refreshFoot(string $pagename): void
    {
        $league = array(
            0 => 39,
            1 => 61,
    ...
    public static function refreshAll(string $pagename): void
    {
        if ($pagename == "index.php") {
            ...
            if ($newtime - $oldtime > 3600) {
                ...
                ApiController::refreshFoot($pagename);
                ApiController::refreshBasket($pagename);
            }
        } else {
