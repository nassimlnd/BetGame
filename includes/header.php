                ...
                <div class="dropdown-menu">
                    <div class="dropdown-links-container">
                        <a href="index.php?page=sports&sport=basket" class="dropdown-links">
                            ...
                            Basket-ball</a>
                        <a href="index.php?page=sports&sport=football" class="dropdown-links">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em"
                                 height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                <path fill="currentColor"
            ...
            <div class="profil-menu">
                <div class="profil-links-container">
                    ...
                    <div class="profil-menu-buttons">
                        <a href="src/Controllers/LoginController.php?action=logout" class="profil-logout-button">Se déconnecter</a>
                    </div>
                </div>
            </div>
        </div>
